...
> Latest line built from upstream OpenAI Codex `rust-v0.115.0` for Android Termux. The separate LTS line remains available for Termux, Linux, and macOS as `@mmmbuto/codex-cli-lts`.
