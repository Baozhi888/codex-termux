...
- **v0.117.2-termux**: beta release to validate Android API 29 build output on Termux ARM64; verify native TLS layout on-device before promoting anything back to `latest`
