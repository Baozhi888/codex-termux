...
Codex Version: codex-cli 0.108.0 / codex-exec 0.108.0
Test Date: 2026-03-05 (CET)
Suite Source: test-reports/suites/latest/termux.md
Primary Raw Log: TERMUX_SAFE_RAW_20260305-015303.log
...
WARNINGS:
---------
- Non-interactive sanity #1 had one transient stream reconnect from API, auto-recovered in the same run.

NOTES:
------
- Global package verified: @mmmbuto/codex-cli-termux@0.108.0-termux.
...
- New dependency crash guards added in suite and validated:
...
- Install Guard / npm package: PASS
  - @mmmbuto/codex-cli-termux@0.108.0-termux found globally.
...
- Version Guard: PASS
  - codex --version => codex-cli 0.108.0
